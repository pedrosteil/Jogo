...
public class JFrametabuleiro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(185, 122, 87));
    ...
    private void carta1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_carta1ActionPerformed
        // TODO add your handling code here:
        selecionarCarta((JButton) evt.getSource());
	...
	private class SwingAction extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			// Necess�rio definir endere�o do servidor e nome do jogador
                        String servidor = ator.solictarEnderecoServidor();
                        String nome = ator.solicitarNomeJogador();
			String mensagem = ator.conectar(servidor, nome);
			JOptionPane.showMessageDialog(null, mensagem);
                        ator.setConectado(true);
		}
	}
	private class SwingAction_1 extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			String mensagem = ator.desconectar();
	...
	private class SwingAction_2 extends AbstractAction {
		...
		public void actionPerformed(ActionEvent e) {
			String mensagem = ator.iniciarPartida();
			JOptionPane.showMessageDialog(null, mensagem);
		}
	}
